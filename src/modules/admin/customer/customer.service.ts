...
export class CustomerService {
  ...
  async getCustomerByParams(where: { [key: string]: any }, select = '*'): Promise<CustomerEntity> {
  ...
  async getCustomerOrders(customer: CustomerEntity, pagination: IPagination): Promise<OrderEntity[]> {
